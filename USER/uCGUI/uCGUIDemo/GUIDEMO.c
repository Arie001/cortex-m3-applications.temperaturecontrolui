...
Documented By: Nandan Mehta
Versioning   : Mercurial
Code protected by copyright laws (c) 2002.
----------------------------------------------------------------------
*/
...
/************************************
 *	All application write in separate c files with their main
 *	function name equals to the file name. Then put the name of 
 *	the file in this _apfTest.
 * @description by siddharth kaul
 *************************************/
...
/*
 * #exportedRoutine
 * @function-name:		GUIDEMO_SetBkColor(GUI_COLOR Color)
 * @retuen:				GUI_COLOR
 * @description:
 */
...
/*
 * #exportedRoutine
 * @function-name:		GUIDEMO_SetColor(GUI_COLOR Color)
 * @retuen:				GUI_COLOR
 * @description:
 */
...
/*
 * #exportedRoutine
 * @function-name:		GUIDEMO_Delay(int t)
 * @retuen:				int
 * @description:
 */
...
/*
 * #exportedRoutine
 * @function-name:		GUIDEMO_Wait(void)
 * @returns:			void
 * @description:
 */
...
/*
 * #exportedRoutine
 * @function-name:		GUIDEMO_CheckCancel(void)
 * @returns:			int
 * @description:
 */
...
/*
 * #exportedRoutine
 * @function-name:		GUIDEMO_ShowInfo(const char* s)
 * @returns:			void
 * @description:
 */
...
/*
 * #exportedRoutine
 * @function-name:		GUIDEMO_HideInfoWin(void)
 * @returns:			void
 * @description:
 */
...
/*
 * #exportedRoutine
 * @function-name:		GUIDEMO_NotifyStartNext(void)
 * @returns:			void
 * @description:		needs to be called when next program needs to be applicated. 
 */
...
/*
 * #exportedRoutine
 * @function-name:		GUIDEMO_WaitKey(void)
 * @returns:			int
 * @description:
 */
...
/**********************************************************
 * The intro text to be displayed just before start of application
 * Can be used can be skipped depends on application
...
/*
 * #exportedRoutine
 * @function-name:		GUIDEMO_ShowIntro(const char * s, const char * sExp)
 * @returns:			void
 * @description:
 */
...
*		Most of the time this will be used so one can comment or
* 		completely elminate the smaller version
*		but i think the check is necessary
*		@description by siddharth kaul
**********************************************************************
*/
...
void GUIDEMO_main(void) {
  ...
  GUIDEMO_Intro();
	...
	**
	**************************/
	//info window no need for this until and unless required

...
void GUIDEMO_Intro(void) {
  ...
  GUI_DispStringHCenterAt("BRAT", xCenter, y= 15);
  GUI_SetColor(GUI_WHITE);
  GUI_SetFont(&GUI_Font13H_ASCII);
  GUI_DispStringHCenterAt("Begineers Researchers"
                          "\nARM Tablet"
                          , xCenter, y += 30);
  GUI_SetColor(GUI_LIGHTRED);
  GUI_SetFont(&GUI_Font16_ASCII);
  GUI_DispStringHCenterAt("Created By - Siddharth Kaul - Nandan Mehta"
                          , xCenter, y += 40);
  GUIDEMO_Delay(5000);
  ...
  GUI_DispStringHCenterAt("www.PowerMCU.com", LCD_GET_XSIZE() / 2, LCD_GET_YSIZE() - 40);
...
void GUIDEMO_Intro(void) {
  ...
  GUI_DispStringHCenterAt("BRAT", xCenter, y= 10);
  ...
  GUI_DispStringHCenterAt("Begineers Researchers"
                          ...
                          , xCenter, y += 20);
  GUI_SetFont(&GUI_Font10S_ASCII);
  GUI_DispStringHCenterAt("Created By" "\nSiddharth Kaul" "\nNandan Mehta", xCenter, y += 25);
  ...
  //GUI_SetFont(&GUI_Font13B_1);
  //GUI_DispStringHCenterAt("www.PowerMCU.com", LCD_GET_XSIZE() / 2, LCD_GET_YSIZE() - 50);
  //GUIDEMO_Delay(5000);

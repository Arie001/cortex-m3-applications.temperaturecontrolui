...
/*
 * @description Main Dialog Definition
 */
...
/*
 * @description About Dialog Window Id
 */
...
/*
 * @description Lan Setting Dialog Box
 */
...
// USER END
/*
 * @description General Purpose Function to be described Later
...
/* 
 * @description Window Handler for About Dialog
 */
static void _cbDialogAbout(WM_MESSAGE * pMsg) {
  WM_HWIN hItem;
  int Id, NCode;
...
void updateProg()
{
		...
		//	i++;
		//	adc_value_avg = adc_value_avg/10;
		//}
		//temperature[i] = '\0';
